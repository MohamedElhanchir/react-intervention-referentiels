...
function EditForm() {
  ...
  useEffect(() => {
    const fetchFields = async () => {
      ...
      // Assuming response.data is the array provided in the question
    ...
    <Container className="mt-5">
      <Form>
        <Form.Group controlId="formSectionName">
          ...
          {newSectionError && <span style={{ color: 'red' }}>{newSectionError}</span>}
        </Form.Group>
        <Button variant="primary" onClick={handleAddNewSection} disabled={isAddingSection}>
